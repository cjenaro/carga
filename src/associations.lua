...
---@param model_class Model Model class to register association for
---@param association_type string Type of association ("belongs_to", "has_many", "has_one")
---@param association_name string Name of the association
---@param options table? Association options
---@return nil
function Associations.register(model_class, association_type, association_name, options)
	...
	association_registry[class_name][association_name] = {
		...
		foreign_key = options.foreign_key
			or Associations.infer_foreign_key(association_name, association_type, model_class),
...
---@param model_class Model Model class
---@return table associations All associations for the model
...
---@return table? association Association definition or nil
...
---@param association_name string Association name
---@param association_type string Association type
---@return string class_name Inferred class name
...
---@param instance table Model instance
---@param association_name string Association name
---@return table? associated_record Associated record or nil
...
---@param instance table Model instance
---@param association_name string Association name
---@return table[] associated_records Array of associated records
...
---@param instances table[] Array of model instances
---@param association_names string[] Array of association names to load
---@return nil
...
function Associations.eager_load_has_many(instances, association)
	...
	if next(primary_ids) then
		...
		-- Load associated records
		local associated_records =
			associated_class:where(association.foreign_key .. " IN (" .. table.concat(ids, ",") .. ")"):all()
