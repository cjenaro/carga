...
---@class QueryBuilder
---@field model_class Model Associated model class
---@field table_name string Database table name
---@field select_clause string Selected fields clause
---@field where_conditions table[] WHERE conditions
---@field join_clauses table[] JOIN clauses
---@field order_clauses table[] ORDER BY clauses
---@field group_clauses table[] GROUP BY clauses
---@field having_clauses table[] HAVING clauses
---@field limit_value number? LIMIT value
---@field offset_value number? OFFSET value
---@field params table[] Query parameters
---@field includes_list table[] Associations to include
local QueryBuilder = {}
QueryBuilder.__index = QueryBuilder

-- Create new query builder instance
---@param model_class Model Model class to query
---@return QueryBuilder builder New query builder instance
...
-- SELECT clause
---@param columns string|string[] Fields to select
---@return QueryBuilder builder Self for chaining
	...
	if #builder.where_conditions > 0 then
		...
		if type(conditions) == "table" then
			...
			table.insert(
				...
				"(" .. last_condition .. " OR " .. table.concat(or_conditions, " AND ") .. ")"
			)
		else
...
-- Get first result
---@return table? row First matching row or nil
...
---@return table? row Found record or nil
...
---@return table? row First matching record or nil
